...
base_url = "https://www.joongang.co.kr/politics/general?startDate=2020-06-01&endDate=2020-07-31&page={}"  #객관적인 자료 확보를 위해 아무 검색 키워드 없이 정치 면 크롤링 (정치일반)
...
plt.xlabel("단어")
plt.ylabel("빈도수")
plt.title("중앙일보 코로나19 <20년 6월 - 정치> 관련 기사 단어 빈도수 분석")
plt.show()

# 결과 출력
print("중앙일보 코로나19 <20년 6월 - 정치> 관련 기사 중 가장 많이 등장한 단어 50개:")
