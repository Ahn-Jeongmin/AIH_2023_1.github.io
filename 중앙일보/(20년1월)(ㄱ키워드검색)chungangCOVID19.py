...
base_url = "https://www.joongang.co.kr/search/news?keyword=코로나&startDate=2020-01-19&endDate=2020-02-19&sfield=all&page={}"
for page in range(1,115):
    url = base_url.format(page)
    html_urls.append(url)


base_url = "https://www.joongang.co.kr/search/news?keyword=코로나&startDate=2020-02-20&endDate=2020-03-19&sfield=all&page={}"
...
plt.xlabel("단어")
plt.ylabel("빈도수")
plt.title("중앙일보 20년 1월 코로나19 키워드 검색 기사 단어 빈도수 분석")
plt.show()

# 결과 출력
print("중앙일보 코로나19  지급 후 기사 중 가장 많이 등장한 단어 50개:")
