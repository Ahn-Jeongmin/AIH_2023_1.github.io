...
base_url = "https://www.joongang.co.kr/search/news?keyword=코로나&startDate=2021-01-01&endDate=2021-01-31&sfield=all&page={}"
for page in range(1,140):
    url = base_url.format(page)
    html_urls.append(url)

base_url = "https://www.joongang.co.kr/search/news?keyword=코로나&startDate=2021-02-01&endDate=2021-02-28&sfield=all&page={}"
...
plt.xlabel("단어")
plt.ylabel("빈도수")
plt.title("중앙일보 21년 1월 코로나19 키워드 검색 기사 단어 빈도수 분석")
plt.show()

# 결과 출력
print("중앙일보 21년 1월 코로나19 지급 후 기사 중 가장 많이 등장한 단어 50개:")
