...
base_url = "https://www.donga.com/news/search?p={}&query=코로나&check_news=91&more=1&sorting=1&search_date=5&v1=20210101&v2=20210331"

html_urls = []
for page in range(1, 11582, 15):
...
for url in html_urls:
    ...
    # URL 추출
    cards = soup.select(
        'div#dongawrap > div.search_wrap > div#container > div#content > div.sch_cont > div.schcont_wrap > div.result_cont > div.articleList.article_list > div.rightList > span.tit > a')
    for card in cards:
...
plt.xlabel("단어")
plt.ylabel("빈도수")
plt.title("동아일보 21년 1월 코로나19 키워드 검색 기사 단어 빈도수 분석")
plt.show()

# 결과 출력
print("동아일보 21년 1월 코로나19 키워드 검색 중 가장 많이 등장한 단어 50개:")
