excluded_words = [
    # 기사관련 단어
    "동아일보", "이미지좋아요슬퍼요", "이미지화나요공유", "이미지공유기사추천", "이미지기사추천공유하기닫기copyright", "dongacom", "이미지",
    "추천", "공유", "기사", "기자", "공유", "뷰", "콘텐츠", "연재", "이슈","동아",
    #의미없는 단어
    ...
    "듯","앞","여","두","물","후","띠","나","처음","거","액","관","배","지난주","원", "줌","컷","다음","땐","이제","누구","탓","놈","갑","이재","몹시","육박",
    "해시태그",
    #논의필요
    "확","진자"
]