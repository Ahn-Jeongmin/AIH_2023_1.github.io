...
base_url = "https://search.hani.co.kr/search/newslist?searchword=%EC%BD%94%EB%A1%9C%EB%82%98&startdate=2020.06.01&enddate=2020.07.31&page={}&sort=desc"
...
plt.xlabel("단어")
plt.ylabel("빈도수")
plt.title("한겨레 코로나 관련 20년 6월 키워드 검색 기사 단어 빈도수 분석")
plt.show()

# 결과 출력
print("한겨례 코로나 관련 20년 6월 키워드 검색 기사 중 가장 많이 등장한 단어 50개:")
